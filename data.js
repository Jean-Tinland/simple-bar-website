...
export const locales = {
  en: {
    ...
    'installation-description-3':
      'The last thing you need to do is downloading <a href="https://www.jetbrains.com/lp/mono/" target="_blank" rel="noopener, noreferrer">JetBrains Mono</a> font and install it. Otherwise, you can simple set another font in the settings module.<br/><br/>',
  ...
  fr: {
    ...
    'installation-description-3':
      'Pour finir, vous aurez besoin de télécharger la police <a href="https://www.jetbrains.com/lp/mono/" target="_blank" rel="noopener, noreferrer">JetBrains Mono</a> puis installer cette dernière. Dans le cas contraire, la police "monospace" par défaut de votre système sera utilisée. Sinon, vous pouvez simplement définir une autre police d\'écriture dans les paramètres.<br/><br/>',
...
export const images = [
  ...
  {
    title: {
      en: 'Gruvbox example in <a href="https://github.com/mTvare6" target="_blank" rel="noopener noreferrer">@mTvare6</a> workflow',
      fr: 'Exemple avec les couleurs du theme Gruvbox, <a href="https://github.com/mTvare6" target="_blank" rel="noopener noreferrer">@mTvare6</a>'
    },
